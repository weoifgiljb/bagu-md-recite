...
要衡量和分析 JavaScript 性能，可以使用 Chrome DevTools、Lighthouse、WebPageTest 和 JSBench 等工具。Chrome DevTools 提供了一个用于分析的 Performance 面板，Lighthouse 提供性能指标的审核，WebPageTest 允许进行详细的性能测试，而 JSBench 有助于比较不同 JavaScript 代码段的性能。
...
JSBench 是一个用于比较不同 JavaScript 代码段性能的工具。它允许您创建和运行基准测试，以查看哪个代码的性能更好。

- 访问 [JSBench](https://jsbench.me/)
